...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 1. Mobile Menu Toggle Feature (if applicable)
    ...
    // 4. Top Left Dropdown Menu Toggle (Optimized for Mobile Touch & Clicks)
    ...
    if (dropBtn && dropdownContent) {
        ...
        // Listen for both clicks and mobile touches for instant responsiveness
        dropBtn.addEventListener('click', toggleDropdown);
        dropBtn.addEventListener('touchstart', toggleDropdown, { passive: false });

        // Close dropdown if user taps/clicks anywhere else on the page
